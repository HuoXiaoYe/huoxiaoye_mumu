...
function ButtonWrap() {
    ...
    function handleClick(v:string = "jskdfal"){
        console.log(v)
    }    
    return (
            ...
            <div className="button-item">
                ...
                <ul>
                    <li><MUButton>默认按钮</MUButton></li>
                    {
                        buttonList.map((item)=>{
                            return (
                            <li><MUButton type={item.type}  key={item.type + Math.random()}>{item.value}</MUButton></li>
                            )
                        })
                    }
                </ul>
                ...
                <li><MUButton disabled={true}>禁用按钮</MUButton></li>
                    {
                        buttonList.map((item)=>{
                            return (
                            <li><MUButton type={item.type} disabled={true}  key={item.type + Math.random()}>{item.value}</MUButton></li>
                            )
                        })
                    }
                </ul>
                ...
                <ul>
                    <li><MUButton size="small">小型按钮</MUButton></li>
                    {
                        buttonList.map((item)=>{
                            return (
                            <li><MUButton type={item.type} size="small" key={item.type + Math.random()}>{item.value}</MUButton></li>
                            )
                        })
                    }
                </ul>
